...
HD_PWD='C:/Users/PC-014/Desktop/Lab9_FSM/Lab9_FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log consec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source consec.tcl
