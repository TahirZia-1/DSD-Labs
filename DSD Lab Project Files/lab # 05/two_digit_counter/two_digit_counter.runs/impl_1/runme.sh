...
HD_PWD='D:/Vivado Lab projects/two_digit_counter/two_digit_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zero_99.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zero_99.tcl -notrace
