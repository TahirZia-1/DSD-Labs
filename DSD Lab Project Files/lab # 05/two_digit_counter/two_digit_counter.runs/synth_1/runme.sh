...
HD_PWD='D:/Vivado Lab projects/two_digit_counter/two_digit_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zero_99.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zero_99.tcl
